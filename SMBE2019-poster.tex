...
\usecolorstyle[colorPalette=BlueGrayOrange]{Denmark}
 ...
 \begin{document}
     ...
     \maketitle
      ...
      \block[titleoffsety=-1cm,bodyoffsety=-1cm]{0. Introduction}{\vspace{2em}
...
%         \end{quote}
     ...
     \begin{columns}%blocks will be placed into columns
         \column{.5}
         \block[roundedcorners=40]{1. Tree sequences}{
...
%     }
     ...
     \note[targetoffsetx=21cm, targetoffsety=-35cm,rotate=0,angle=270,radius=8cm,width=.75\textwidth,innersep=.4cm]{
     {\bf Accessing the materials in this poster:}\\[2mm]
     ...
     \column{.5}
         \block[bodyverticalshift=8.5cm]{2. Local ancestry in tree sequences}{
...
%          }
 ...
 \block[titleoffsety=-1cm,bodyoffsety=-1cm]{5. Acknowledgements and references}{
blah 	
 }
