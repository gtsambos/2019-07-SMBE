...
\begin{tikzpicture}[node distance=10mm and 5mm,xscale=2,yscale=2]

\tikzset{greynode/.style={font=\large,node distance=3cm and 2cm,fill=black!10,draw=black!30,inner sep=0pt,minimum size=12mm,shape=circle},
...
%\begin{tabularx}{.15\textwidth}{p{3cm}p{3cm}p{3cm}X}
%\toprule
